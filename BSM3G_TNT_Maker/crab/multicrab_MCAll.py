...
'/TTTW_TuneCP5_13TeV-madgraph-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_new_pmx_94X_mc2017_realistic_v14-v2/MINIAODSIM',
'/TTWH_TuneCP5_13TeV-madgraph-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_new_pmx_94X_mc2017_realistic_v14-v1/MINIAODSIM',
'/GluGluHToZZTo4L_M125_13TeV_powheg2_minloHJJ_JHUGenV7011_pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v2/MINIAODSIM',
...
for d in [6,41]:
    ...
    if 'Fall17' in datasetnames[d]:
        DataEra = '2017'
        print 'multicrab.py: Run Fall17 and set DataEra to:' + DataEra
    elif 'Summer16' in datasetnames[d]:
        DataEra = '2016'
        print 'multicrab.py: Run Summer16 and set DataEra to:' + DataEra
    else:
        print '##### Data Era ERROR ######\n Fall17 or Summer16 must be contained in datasetnames ' 
   
    nameDataEra = "optionDataEra="+DataEra
    ...
    config.JobType.psetName    = '/afs/cern.ch/work/b/binghuan/private/BSMFWTest/CMSSW_9_4_10/src/BSMFramework/BSM3G_TNT_Maker/python/miniAOD_MCAll.py'

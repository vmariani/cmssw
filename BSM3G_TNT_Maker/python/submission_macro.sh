...
TASK="TT_" #name of the output directory and the files
INPUT_DATASET=(`cat listTT.txt`) #listDS_fixed.txt #list of the input files
...
echo "#!/bin/bash
mv ${TASK}${i}.root $PWD/$OUTPUT_FOLDER/${TASK}${i}.root

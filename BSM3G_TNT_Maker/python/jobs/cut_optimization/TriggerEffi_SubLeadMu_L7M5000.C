void TriggerEffi_SubLeadMu_L7M5000()
{
//=========Macro generated from canvas: c1/c1
//=========  (Tue Dec  4 23:13:05 2018) by ROOT version6.10/09
   TCanvas *c1 = new TCanvas("c1", "c1",0,23,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c1->Range(0.7165691,0.803561,3.480106,1.037707);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetLogx();
   ...
   Graph_Graph1001->SetMinimum(0.834);
   Graph_Graph1001->SetMaximum(1.026);

void TriggerEffi_LeadMu_L7M7000()
{
//=========Macro generated from canvas: c1/c1
//=========  (Tue Dec  4 23:19:05 2018) by ROOT version6.10/09
   TCanvas *c1 = new TCanvas("c1", "c1",0,23,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c1->Range(0.5893547,-0.3487805,3.905997,2.334146);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetLogx();
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","Graph",100,22.5,5497.5);
   ...
   gre->Draw("ap");
   TLine *line = new TLine(30,1,7000,1);

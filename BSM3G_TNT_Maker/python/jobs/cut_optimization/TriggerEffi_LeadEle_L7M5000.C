void TriggerEffi_LeadEle_L7M5000()
{
//=========Macro generated from canvas: c1/c1
//=========  (Tue Dec  4 23:33:39 2018) by ROOT version6.10/09
   TCanvas *c1 = new TCanvas("c1", "c1",0,23,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c1->Range(-0.04022239,-0.1743902,3.939272,1.167073);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetLogx();
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","Graph",100,7.5,5499.167);
   ...
   gre->Draw("ap");
   TLine *line = new TLine(30,1,5000,1);

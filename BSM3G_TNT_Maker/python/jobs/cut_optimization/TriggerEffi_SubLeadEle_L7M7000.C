void TriggerEffi_SubLeadEle_L7M7000()
{
//=========Macro generated from canvas: c1/c1
//=========  (Thu Dec 20 11:23:28 2018) by ROOT version6.10/09
   TCanvas *c1 = new TCanvas("c1", "c1",0,23,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c1->Range(0.08692888,0.8199463,3.513591,1.021898);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetLogx();
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","Graph",100,7.5,2199.167);
   Graph_Graph1001->SetMinimum(0.8462);
   Graph_Graph1001->SetMaximum(1.0118);
   Graph_Graph1001->SetDirectory(0);
   Graph_Graph1001->SetStats(0);
   Graph_Graph1001->SetFillColor(63);
   Graph_Graph1001->SetLineStyle(0);
   Graph_Graph1001->SetMarkerStyle(20);
   Graph_Graph1001->GetXaxis()->SetTitle("SubLead Ele p_{T} [GeV]");

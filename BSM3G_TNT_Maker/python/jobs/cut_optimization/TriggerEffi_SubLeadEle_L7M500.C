void TriggerEffi_SubLeadEle_L7M500()
{
//=========Macro generated from canvas: c1/c1
//=========  (Tue Dec  4 23:37:43 2018) by ROOT version6.10/09
   TCanvas *c1 = new TCanvas("c1", "c1",0,23,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c1->Range(0.08692888,0.8967805,3.513591,1.013854);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetLogx();
   ...
   Graph_Graph1001->SetMinimum(0.912);
   Graph_Graph1001->SetMaximum(1.008);

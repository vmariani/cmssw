void TriggerEffi_SubLeadMuon_TTpST()
{
//=========Macro generated from canvas: c1/c1
//=========  (Mon Dec 10 18:09:13 2018) by ROOT version6.10/09
   TCanvas *c1 = new TCanvas("c1", "c1",0,23,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c1->Range(0.08692888,-0.3487805,3.513591,2.334146);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetLogx();

...
void  Rootplizer_HeavyNeutrino_SigTopDY(const char*  Input = "", const char*  Output =""){
...
double get_wgtlumi(string FileName){
 double wgt=1;
 if(FileName.find("TT") != std::string::npos) wgt=88.29/8705576;
 if(FileName.find("DY") != std::string::npos) wgt=6225.42/97800939;
 if(FileName.find("ST") != std::string::npos) wgt=34.91/7581624;
 if(FileName.find("SaT") != std::string::npos) wgt=34.97/7780870;
 if(FileName.find("WW") != std::string::npos) wgt=75.8/7791498;
 if(FileName.find("WZ") != std::string::npos) wgt=27.6/3849787;
 if(FileName.find("ZZ") != std::string::npos) wgt=12.14/1949768;
 if(FileName.find("WJets") != std::string::npos) wgt=52940.0/77841284;
 if(FileName.find("WJetsHT70To100") != std::string::npos) wgt=1353.0/10094300;
 if(FileName.find("WJetsHT100To200") != std::string::npos) wgt=1346.0/35862893;
 if(FileName.find("WJetsHT200To400") != std::string::npos) wgt=407.9/21144259;
 if(FileName.find("WJetsHT400To600") != std::string::npos) wgt=57.48/14267691;
 if(FileName.find("WJetsHT600To800") != std::string::npos) wgt=12.87/21664601;
 if(FileName.find("WJetsHT800To1200") != std::string::npos) wgt=5.366/20348816;
 if(FileName.find("WJetsHT1200To2500") != std::string::npos) wgt=1.074/20258624;
 if(FileName.find("WJetsHT2500ToInf") != std::string::npos) wgt=0.008001/21495421;

/*
 if(FileName.find("DYHT0To100") != std::string::npos) wgt=4895.*1.246/9004328;
 ...
 if(FileName.find("TT") != std::string::npos) wgt=831.76/97907991;
 if(FileName.find("ST") != std::string::npos) wgt=35.6/1000000;
 if(FileName.find("SaT") != std::string::npos) wgt=35.6/999400;
 ...
 if(FileName.find("WW") != std::string::npos) wgt=118.70838/988418;
 if(FileName.find("WZ") != std::string::npos) wgt=47.13/1000000;
 if(FileName.find("ZZ") != std::string::npos) wgt=16.523/985600;
 if(FileName.find("QCDHT100To200") != std::string::npos) wgt=27990000/82095800;
 if(FileName.find("QCDHT200To300") != std::string::npos) wgt=1712000/18784379;
 if(FileName.find("QCDHT300To500") != std::string::npos) wgt=347700/16909004;
 if(FileName.find("QCDHT500To700") != std::string::npos) wgt=32100/19294591;
 if(FileName.find("QCDHT700To1000") != std::string::npos) wgt=6831/15531969;
 if(FileName.find("QCDHT1000To1500") != std::string::npos) wgt=1207/5000610;
 if(FileName.find("QCDHT1500To2000") != std::string::npos) wgt=119.9/2711608;
 if(FileName.find("QCDHT2000ToInf") != std::string::npos) wgt=25.24/721306;
*/
